...
IntroMusic = {
  ...
  \tweak extra-offset #'(0 . 0.5)\mark \markup\smaller\smaller\bold\caps { Intro }
  \set Score.currentBarNumber = 0
  r8[ a'8 a'8 a'8 |
  \time 4/4
  ...
  \mark \markup\smaller\smaller\bold\caps { Interlude }
  r8[ a'8 a'8 a'8 |
  \time 4/4
  a'4 r4 r8[ a'8 a'8 a'8 | % 1
  b'4 r4 r8[ b'8 b'8 b'8 | % 2
...
SopranoMusic = {
  ...
  d''4 d''4 cis''4 b'4  % 32
  a'2 r8 a'8 a'8 a'8  % 33
...
AltoMusic = {
  ...
  g'4 r4 g'8 g'4 g'8 \spanBarOff % 30
  g'4 r4 r8 g'8 g'8 a'8  % 31
  g'8 g'8 g'4 a'4 g'4  % 32
  fis'2 r4 fis'8 g'8  % 33
  a'4 a'4 a'4 gis'4 \spanBarOn
